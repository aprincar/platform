...
export const WORLDS: WorldInfo[] = [
  ...
  },
  {
    ...
    color: '#4F6EF7',
    accentBg: '#EEF1FF',
    description: 'Reconhecimento de letras, pré-escrita, letras de forma e cursiva em progressão motora.',
    childSummary: 'Encontre letras, siga caminhos e avance até letras de forma e cursiva!',
    skillIds: [
      'literacy.letter.recognition',
      'motor.prewriting.lines',
      'motor.prewriting.curves',
      'writing.trace-letter',
      'writing.cursive.trace',
      'writing.cursive.join',
    ],
    gameIds: [
    ...
    trail: ['Reconhecer', 'Pré-escrita', 'Letras de forma', 'Cursiva'],
  },
  {
    id: 'logic',
  ...
  },
  {
    ...
    childSummary: 'Combine cores, pinte por pistas e depois crie livremente do seu jeito!',
    ...
    trail: ['Perceber cores', 'Combinar', 'Pintar com pistas', 'Criar livremente'],
  },
  {
    id: 'spatial',
